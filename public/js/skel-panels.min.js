...
skel.registerPlugin("panels", function () {
    var b = {
        ...
        initElement: function (e) {
            ...
            case "panel":
                ...
                case "bottom":
                    ...
                    b._.vars.isTouch ? d.css("overflow-y", "scroll").css("-webkit-overflow-scrolling", "touch").bind("touchstart", function (b) {
                ...
                break;
            case "overlay":
                d.css("z-index", b.config.baseZIndex).css("position", "fixed").addClass("skel-panels-overlay"), d.css("width", c.width).css("height", c.height), (h = b.positions.overlays[c.position]) || (c.position = "top-left", h = b.positions.overlays[c.position]), d.addClass("skel-panels-overlay-" + c.position).data("skel-panels-overlay-position", c.position), b._.iterate(h, function (e) {
                    d.css(e, h[e]);
        ...
        initJQueryUtilityFuncs: function () {
            ...
            if (b.config.useTransform && 10 <= b._.vars.IEVersion && (!b.config.transformBreakpoints || b._.hasActive(b.config.transformBreakpoints.split(",")))) jQuery.fn._skel_panels_translateOrigin = function () {
                ...
                jQuery.fn._skel_panels_translate = function (c, d) {
                    ...
                    for (h = 0; h < this.length; h++) {
                        var k = this[h],
                            n = jQuery(k),
                            m;
                        if (!e[k.id]) if (m = b.positions.overlays[n.data("skel-panels-overlay-position")]) e[k.id] = m;
                        else if (m = b.positions.panels[n.data("skel-panels-panel-position")]) for (e[k.id] = {}, f = 0; m[f]; f++) e[k.id][m[f]] = parseInt(n.css(m[f]));
